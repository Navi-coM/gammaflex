...
<html lang="ru">
  ...
  <body>
    <div class="wrapper">
      ...
      <div class="header">
        <a href="./index.php"><img id="block1" class="header__logo" src="./img/without_shadow1.png" alt="logotip"></a>
        ...
        <div id="modal_form"> 
         ...
         <!--  <div id="modal_form"> 
          ...
          <div id="block-animate" class="block-panel__double-section block-panel__section--purple2">
            <a href="./html/package_rylon.html">
